...
void my_app_init(my_app_t *app_struct)
{
    ...
    app_struct->sounds[SND_BACKGROUND] = al_ext_load_sound("music.wav", 1);
...
bool my_app_logic(void * arg)
{
    ...
    ALLEGRO_SAMPLE *  music       = app_struct->sounds[SND_BACKGROUND];
    ...
    al_ext_play_sound(music, ALLEGRO_PLAYMODE_LOOP);
